...
class HomeBorrower extends React.Component {
    ...
    render() {
        ...
        const emptyView = (
            <div className="container">
                <div className="empty-page">
                    <b>{this.props.borrower}</b> isn't registered or hasn't written any memo
                </div>
            </div>
        );
        ...
        return (
            <div className="wrapper">
                { typeof this.props.borrower !== 'undefined' ? wallHeader : undefined }
...
HomeBorrower.PropTypes = {
    borrower: React.PropTypes.string
};

HomeBorrower.defaultProps = {
    borrower: undefined
};
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        memoListRequestbyBorrower: (isInitial, listType, id, borrower) => {
            return dispatch(memoListRequestbyBorrower(isInitial, listType, id, borrower));
        },
